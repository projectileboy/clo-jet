...
//        });
    ...
    public void disposeComponent() {
        ToolWindowManager.getInstance(myProject).unregisterToolWindow("REPL" /*message("repl.toolWindowId")*/);
    ...
    private void initToolWindow() throws ExecutionException, IOException {
        if (myProject != null) {
            ...
            ToolWindow window = manager.registerToolWindow("REPL" /*message("repl.title")*/, view.getComponent(), ToolWindowAnchor.BOTTOM);
