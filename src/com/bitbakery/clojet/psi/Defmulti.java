...
/**
 * PSI element representing a multi-method definition ("defmulti") in Clojure.
 */
public class Defmulti extends VariableAssignment {
    public Defmulti(@NotNull final ASTNode node) {
        super(node);
    }
