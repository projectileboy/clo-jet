...
/**
 * PSI element representing a named structure definition ("defstruct") in Clojure.
 */
public class Defstruct extends VariableAssignment {
    public Defstruct(@NotNull final ASTNode node) {
        super(node);
    }
