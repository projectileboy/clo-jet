...
/**
 * PSI element representing a named method definition ("defmethod") in Clojure.
 */
public class Defmethod extends VariableAssignment {
    public Defmethod(@NotNull final ASTNode node) {
        super(node);
    }
